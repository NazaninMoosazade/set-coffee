...
const Stepper = ({ step }) => {
  return (
    ...
    >
      <div className="flex items-center justify-center flex-row-reverse gap-4 sm:gap-6 lg:gap-8 pb-16 text-lg sm:text-xl lg:text-2xl">
        {/* سبد خرید */}
        <Link
          href="/cart"
          className={`${
            step === "cart" ? "opacity-100 font-bold" : "opacity-70"
          } mt-1 mb-1 uppercase`}
        >
          سبد خرید
        </Link>
        ...
        {step === "checkout" || step === "complate" ? (
          <Link
            href="/checkout"
            className={`${
              step === "checkout" ? "opacity-100 font-bold" : "opacity-70"
            } mt-1 mb-1 uppercase`}
          >
            پرداخت
          </Link>
        ...
        {step === "complate" ? (
          <Link
            href="/complate"
            className={`${
              step === "complate" ? "opacity-100 font-bold" : "opacity-70"
            } mt-1 mb-1 uppercase`}
          >
            تکمیل سفارش
          </Link>
