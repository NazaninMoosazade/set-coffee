...
const Footer = () => {
  return (
    <footer className="bg-neutral-900 mt-20 pt-10 text-white">
      <main className="container mx-auto flex flex-row-reverse justify-between pb-10 text-right">
        {/* بخش توضیحات */}
        <section className="w-72 p-3 text-sm leading-relaxed space-y-4">
        ...
        {/* بخش مجوزها */}
        <div className="grid grid-cols-2 gap-3 h-52 items-center">
          <img
      ...
      <div className="container mx-auto">
        <p className="py-5 text-xs text-right text-neutral-400 flex items-center gap-1">
